...
public class WebScraper_Search_Test extends WebScraper_Base_Test {

    @Test
    public void canQueryRealEstate_WithSuburbParameter_AndMakeSubsequentCallsToGetDetailedPages() throws Exception {
        String htmlPage = loadPageFromTestResources("src/test/resources/stub/realestate/single-page-result-searchCurrentlyListed-page.html");
    ...
    public void canGetNextPage() throws Exception {
        String firstpage = loadPageFromTestResources("src/test/resources/stub/realestate/multi-page-result-searchCurrentlyListed-page.html");
        String secondpage = loadPageFromTestResources("src/test/resources/stub/realestate/single-page-result-searchCurrentlyListed-page.html");
        mockServer.expect(once(), requestTo(REALESTATE_DOMAIN + "/buy/in-parramatta%2c+nsw+2150/list-1?numBaths=any&numParkingSpaces=any&maxBeds=any"))
